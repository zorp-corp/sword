...
pub fn jet_mink(
    ...
    let cold = todo!("pass in cold state");
    let warm = todo!("pass in warm state");
    let hot = todo!("pass in hot state");

    //  XX: NonDeterministic errors need to bail here, too
    match interpret(stack, newt, cold, warm, hot, v_subject, v_formula) {
